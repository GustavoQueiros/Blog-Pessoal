...
//definir uma porta aleatoria para realizar o teste
...
public class UsuarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate;//requisições http
	...
	//nosso teste que cadastra o usuario
	@Test
	@DisplayName("Cadastra um usuário")
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>
		(new Usuario(0L, "Boot", "boot@boot.com", "bootboot", ""));
